...
from app.domain.session_models import ConversationTurn, SessionPhase, ToolCallRecord
...
@pytest.mark.asyncio
async def test_handle_hook_event_does_not_bind_session_by_unique_workdir_only(
