"""Pure text formatting utilities for Telegram HTML rendering.

Canonical location for markdown-to-Telegram-HTML conversion and message splitting.
These are pure functions with no dependency on aiogram or Telegram Bot API.
"""
